      ...
      <main className="flex-grow flex items-center justify-center px-2">
        <div className="w-full max-w-5xl flex flex-col md:flex-row bg-[#23272b] rounded-3xl shadow-2xl overflow-hidden border-2 border-[#43aa8b]">
          ...
          <div className="hidden md:flex flex-col justify-center items-center bg-gradient-to-br from-[#2d353c] via-[#3a4d4f] to-[#23272b] p-12 w-1/2 min-h-[600px] border-r-2 border-[#43aa8b]">
            <h2 className="text-4xl font-extrabold text-[#f1c40f] mb-4 tracking-wider font-serif uppercase drop-shadow-lg text-center">Country Dance Platform</h2>
            <p className="text-lg text-[#e0eceb] mb-8 text-center max-w-xs font-mono">Book, manage, and grow your bar or event with authentic country swing & line dance lessons.</p>
          ...
          <div className="flex-1 flex flex-col justify-center p-8 md:p-12 bg-[#23272b]">
            ...
            {/* Demo Button */}
            <div className="mb-6 p-4 bg-[#2d353c] rounded-lg border border-[#43aa8b]">
              <p className="text-sm text-[#e0eceb] mb-3 text-center font-medium">Try the demo:</p>
              <div className="flex gap-2">
                <button
                  onClick={handleDemoLogin}
                  className="flex-1 bg-[#43aa8b] hover:bg-[#f1c40f] text-[#23272b] py-2 px-4 rounded-lg text-sm font-semibold transition-colors"
                >
                  Student Demo
                </button>
              </div>
            ...
            <div className="relative mb-6">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-[#43aa8b] opacity-30"></div>
              </div>
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#23272b] text-[#43aa8b]">Or continue with real account</span>
              </div>
            </div>
            {error && (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {isSignUp && (
                <>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#e0eceb] mb-1">Date of Birth</label>
                    <input
                      type="date"
                      value={dob}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#e0eceb] mb-1">Skill Level</label>
                    <select
                      value={skillLevel}
